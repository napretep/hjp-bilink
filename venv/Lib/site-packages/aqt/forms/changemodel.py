...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.BROWSING_CHANGE_NOTE_TYPE))
        self.label_6.setText(tr(TR.BROWSING_CURRENT_NOTE_TYPE))
        self.label.setText(tr(TR.BROWSING_NEW_NOTE_TYPE))
        self.tgroup.setTitle(tr(TR.EDITING_CARDS))
        self.fgroup.setTitle(tr(TR.EDITING_FIELDS))
