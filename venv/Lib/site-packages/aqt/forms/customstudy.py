...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.ACTIONS_CUSTOM_STUDY))
        self.radioAhead.setText(tr(TR.CUSTOM_STUDY_REVIEW_AHEAD))
        self.radioForgot.setText(tr(TR.CUSTOM_STUDY_REVIEW_FORGOTTEN_CARDS))
        self.radioNew.setText(tr(TR.CUSTOM_STUDY_INCREASE_TODAYS_NEW_CARD_LIMIT))
        self.radioRev.setText(tr(TR.CUSTOM_STUDY_INCREASE_TODAYS_REVIEW_CARD_LIMIT))
        self.radioCram.setText(tr(TR.CUSTOM_STUDY_STUDY_BY_CARD_STATE_OR_TAG))
        self.radioPreview.setText(tr(TR.CUSTOM_STUDY_PREVIEW_NEW_CARDS))
        __sortingEnabled = self.cardType.isSortingEnabled()
        self.cardType.setSortingEnabled(False)
        item = self.cardType.item(0)
        item.setText(tr(TR.CUSTOM_STUDY_NEW_CARDS_ONLY))
        item = self.cardType.item(1)
        item.setText(tr(TR.CUSTOM_STUDY_DUE_CARDS_ONLY))
        item = self.cardType.item(2)
        item.setText(tr(TR.CUSTOM_STUDY_ALL_REVIEW_CARDS_IN_RANDOM_ORDER))
        item = self.cardType.item(3)
        item.setText(tr(TR.CUSTOM_STUDY_ALL_CARDS_IN_RANDOM_ORDER_DONT))
