...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.CUSTOM_STUDY_SELECTIVE_STUDY))
        self.activeCheck.setText(tr(TR.CUSTOM_STUDY_REQUIRE_ONE_OR_MORE_OF_THESE))
        self.label.setText(tr(TR.CUSTOM_STUDY_SELECT_TAGS_TO_EXCLUDE))
