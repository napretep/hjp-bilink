...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.EDITING_FIELDS))
        self.fieldAdd.setText(tr(TR.ACTIONS_ADD))
        self.fieldDelete.setText(tr(TR.ACTIONS_DELETE))
        self.fieldRename.setText(tr(TR.ACTIONS_RENAME))
        self.fieldPosition.setText(tr(TR.ACTIONS_REPOSITION))
        self.label_5.setText(tr(TR.FIELDS_EDITING_FONT))
        self.rtl.setText(tr(TR.FIELDS_REVERSE_TEXT_DIRECTION_RTL))
        self.sticky.setText(tr(TR.FIELDS_REMEMBER_LAST_INPUT_WHEN_ADDING))
        self.label_18.setText(tr(TR.ACTIONS_OPTIONS))
        self.sortField.setText(tr(TR.FIELDS_SORT_BY_THIS_FIELD_IN_THE))
