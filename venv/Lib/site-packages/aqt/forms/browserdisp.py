...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.BROWSING_BROWSER_APPEARANCE))
        self.label.setText(tr(TR.BROWSING_OVERRIDE_FRONT_TEMPLATE))
        self.label_2.setText(tr(TR.BROWSING_OVERRIDE_BACK_TEMPLATE))
        self.overrideFont.setText(tr(TR.BROWSING_OVERRIDE_FONT))
