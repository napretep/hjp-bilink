...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.latexsvg.setText(tr(TR.NOTETYPES_CREATE_SCALABLE_IMAGES_WITH_DVISVGM))
        self.label_6.setText(tr(TR.NOTETYPES_HEADER))
        self.label_7.setText(tr(TR.NOTETYPES_FOOTER))
        self.qtabwidget.setTabText(self.qtabwidget.indexOf(self.tab), tr(TR.EDITING_LATEX))
