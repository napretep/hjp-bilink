...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.ADDONS_INSTALL_ADDON))
        self.label.setText(tr(TR.ADDONS_TO_BROWSE_ADDONS_PLEASE_CLICK_THE))
        self.label_2.setText(tr(TR.ADDONS_CODE))
