...
class Ui_ExportDialog(object):
    ...
    def retranslateUi(self, ExportDialog):
        ...
        ExportDialog.setWindowTitle(tr(TR.ACTIONS_EXPORT))
        self.label.setText(tr(TR.EXPORTING_EXPORT_FORMAT))
        self.label_2.setText(tr(TR.EXPORTING_INCLUDE))
        self.includeSched.setText(tr(TR.EXPORTING_INCLUDE_SCHEDULING_INFORMATION))
        self.includeMedia.setText(tr(TR.EXPORTING_INCLUDE_MEDIA))
        self.includeTags.setText(tr(TR.EXPORTING_INCLUDE_TAGS))
        self.includeHTML.setText(tr(TR.EXPORTING_INCLUDE_HTML_AND_MEDIA_REFERENCES))
