...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(tr(TR.BROWSING_BROWSER_OPTIONS))
        self.label.setText(tr(TR.BROWSING_FONT))
        self.label_2.setText(tr(TR.BROWSING_FONT_SIZE))
        self.label_3.setText(tr(TR.BROWSING_LINE_SIZE))
        self.fullSearch.setText(tr(TR.BROWSING_SEARCH_WITHIN_FORMATTING_SLOW))
