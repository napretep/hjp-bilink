...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(tr(TR.PROFILES_PROFILES))
        self.login.setText(tr(TR.PROFILES_OPEN))
        self.add.setText(tr(TR.ACTIONS_ADD))
        self.rename.setText(tr(TR.ACTIONS_RENAME))
        self.delete_2.setText(tr(TR.ACTIONS_DELETE))
        self.quit.setText(tr(TR.PROFILES_QUIT))
        self.openBackup.setText(tr(TR.PROFILES_OPEN_BACKUP))
