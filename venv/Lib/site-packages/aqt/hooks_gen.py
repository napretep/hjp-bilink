...
class _BrowserWillBuildTreeFilter:
    ...
    def append(
        ...
        """(handled: bool, tree: aqt.sidebar.SidebarItem, stage: aqt.sidebar.SidebarStage, browser: aqt.browser.Browser)"""
        self._hooks.append(cb)
...
class _DeckConfDidAddConfigHook:
    ...
    def append(
        self,
        cb: Callable[
            ["aqt.deckconf.DeckConf", "Deck", "DeckConfig", "str", "int"], None
        ],
    ) -> None:
...
class _DeckConfWillRenameConfigHook:
    ...
    _hooks: List[
        Callable[["aqt.deckconf.DeckConf", "Deck", "DeckConfig", "str"], None]
    ] = []
