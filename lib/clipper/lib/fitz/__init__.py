...
fitz.Document.get_page_text = utils.getPageText
fitz.Document.get_toc = utils.getToC
fitz.Document.has_annots = utils.has_annots
fitz.Document.has_links = utils.has_links
fitz.Document.insert_page = utils.insertPage
fitz.Document.new_page = utils.newPage
fitz.Document.scrub = utils.scrub
fitz.Document.search_page_for = utils.searchPageFor
...
fitz.Document.set_toc = utils.setToC
...
fitz.Page.delete_widget = utils.deleteWidget
...
fitz.Page.get_text = utils.getText
fitz.Page.get_image_info = utils.get_image_info
fitz.Page.get_text_blocks = utils.getTextBlocks
fitz.Page.get_text_selection = utils.getTextSelection
fitz.Page.get_text_words = utils.getTextWords
fitz.Page.get_textbox = utils.getTextbox
fitz.Page.insert_image = utils.insert_image
fitz.Page.insert_link = utils.insertLink
...
fitz.Page.search_for = utils.searchFor
fitz.Page.show_pdf_page = utils.show_pdf_page
fitz.Page.update_link = utils.updateLink
...
# Annot
# ------------------------------------------------------------------------
fitz.Annot.get_text = utils.getText
fitz.Annot.get_textbox = utils.getTextbox

# ------------------------------------------------------------------------
# Rect
# ------------------------------------------------------------------------
fitz.Rect.getRectArea = utils.getRectArea
fitz.Rect.getArea = utils.getRectArea

# ------------------------------------------------------------------------
# IRect
# ------------------------------------------------------------------------

fitz.IRect.getRectArea = utils.getRectArea
fitz.IRect.getArea = utils.getRectArea
