...
class 类型_视图结点UI展示:
    ...
    def 开始(项:"类型_视图结点属性项"):
        函数字典= {
                枚举.组件类型.slider:类型_视图结点UI展示.slider,
                枚举.组件类型.label:类型_视图结点UI展示.label,
                枚举.组件类型.checkbox:类型_视图结点UI展示.checkbox,
                枚举.组件类型.text:类型_视图结点UI展示.text,
                枚举.组件类型.customize:类型_视图结点UI展示.customize
            }
...
class 类型_视图结点模型:
    ...
    def 创建结点UI(self):
        ...
        for 属性名 in self.__dict__.keys():
            if isinstance(self.__dict__[属性名],类型_视图结点属性项):
