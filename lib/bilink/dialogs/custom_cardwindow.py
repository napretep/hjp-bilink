...
if not ISLOCAL:
    ...
    class SingleCardPreviewer(Previewer):
        ...
        def _create_gui(self):
            ...
            self._other_side = common_tools.funcs.组件定制.按钮(common_tools.G.src.ImgDir.right_direction,最紧凑布局=True)
            # self._other_side = QPushButton(QIcon(common_tools.G.src.ImgDir.right_direction), "")
            # self._other_side.setSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
            # self._other_side.setContentsMargins(0,0,0,0)
            # self._other_side.setIcon()
            # self.browser_button = QPushButton("show in browser")
            self.edit_button = common_tools.funcs.组件定制.按钮(common_tools.G.src.ImgDir.edit,ToolOrPush="",最紧凑布局=True)
            # self.edit_button = QPushButton(QIcon(common_tools.G.src.ImgDir.edit), "")
            # self.edit_button.setSizePolicy(QSizePolicy.Policy.Minimum, QSizePolicy.Policy.Minimum)
            # self.edit_button.setContentsMargins(0, 0, 0, 0)
