...
# __file_name__ = 'custom_cardwindow2.py'
# __author__ = '十五'
# __email__ = '564298339@qq.com'
# __time__ = '2021/8/9 14:52'
# """
#
...
#
#
# class CustomCardPrev(QMainWindow):
#     def __init__(self, card:Card, parent: QWidget, mw: AnkiQt, on_close: Callable[[], None]):
#         super().__init__()
#         self.card=card
#         self.mw=mw
