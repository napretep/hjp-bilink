...
class Ui_input(object):
    def setupUi(self, input):
        ...
        input.setMinimumSize(QtCore.QSize(300, 600))
        ...
        self.inputTree.header().setDefaultSectionSize(150)
    ...
    def retranslateUi(self, input):
        ...
        self.info.setText(_translate("input", "注:pair可拖拽,可多选,最底层的desc可修改,执行连接或关闭窗口会保存数据.有小概率会出bug"))
