...
from PyQt5.QtWidgets import QDialog, QGridLayout, QTabWidget, QTabBar, QStylePainter, QStyleOptionTab, QStyle, QWidget, \
    QToolButton, QVBoxLayout, QSpinBox, QComboBox, QDoubleSpinBox, QLineEdit, QFormLayout, QLabel, QCheckBox, \
