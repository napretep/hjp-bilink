...
from PyQt5.QtGui import QPainter, QColor, QImage, QPixmap, QPen
from PyQt5.QtWidgets import QApplication, QGraphicsView, QGraphicsPixmapItem, QGraphicsScene, QGraphicsItem, QWidget
...
class ImageView(QGraphicsView):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._item = PageItem(image)  # 放置图像
...
class PageItem(QGraphicsItem):
    def __init__(self, png_path: "str", *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.uuid = hash(self).__str__()  # 这个uuid不用做存储,仅在内存中标记唯一性
        self.png_path = png_path
        self.pageview = self.PageView(superior=self)
    ...
    class PageView(QGraphicsPixmapItem):
        def __init__(self, superior: "Clipper.PageItem" = None, *args, **kwargs):
            super().__init__(*args, **kwargs)
...
if __name__ == '__main__':
    ...
    w = ImageView(image=r'C:\Users\Administrator\Desktop\euler.jpg', background=Qt.black)
    w.show()
    sys.exit(app.exec_())
